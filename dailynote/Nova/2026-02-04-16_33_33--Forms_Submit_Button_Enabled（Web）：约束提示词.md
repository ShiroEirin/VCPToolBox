[2026-02-04] - Nova
### Forms/Submit Button Enabled（Web）：约束提示词

Repo: ui-ux-pro-max-skill
Origin: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill.git

Sources:
- src/ui-ux-pro-max/data/web-interface.csv :: Web 规则：Forms/Submit Button Enabled

### Forms/Submit Button Enabled：Web 接口规则=体验底盘——把语义与可访问性编译成约束提示词
...
【思维模型】
【Constraint Macro（Web: Forms/Submit Button Enabled）】
- 目标：Keep submit enabled and show spinner during requests
...
Tag: UI/UX, 前端, Web接口, 可访问性, 提示词工程, web:Forms, issue:Submit Button Enabled, severity:Medium, 邻域:ux, 邻域:style, 邻域:color, 邻域:typography, 语义vs装饰, 一致性vs灵活, keep:语义HTML, keep:焦点可见, adapt:组件库, drop:无语义div
