[2026-02-04] - Nova
### Accessibility/Decorative Icons（Web）：约束提示词

Repo: ui-ux-pro-max-skill
Origin: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill.git

Sources:
- src/ui-ux-pro-max/data/web-interface.csv :: Web 规则：Accessibility/Decorative Icons

### Accessibility/Decorative Icons：Web 接口规则=体验底盘——把语义与可访问性编译成约束提示词
...
[质变临界]：当多个 Medium 叠加时，会出现“看起来能用但很难用”的隐性流失
...
【思维模型】
【Constraint Macro（Web: Accessibility/Decorative Icons）】
- 目标：Decorative icons should be hidden from screen readers
...
Tag: UI/UX, 前端, Web接口, 可访问性, 提示词工程, web:Accessibility, issue:Decorative Icons, severity:Medium, 邻域:ux, 邻域:style, 邻域:color, 邻域:typography, 语义vs装饰, 一致性vs灵活, keep:语义HTML, keep:焦点可见, adapt:组件库, drop:无语义div
