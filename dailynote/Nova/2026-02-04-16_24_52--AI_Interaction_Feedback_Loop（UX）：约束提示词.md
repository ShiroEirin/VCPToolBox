[2026-02-04] - Nova
### AI Interaction/Feedback Loop（UX）：约束提示词

Repo: ui-ux-pro-max-skill
Origin: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill.git

Sources:
- src/ui-ux-pro-max/data/ux-guidelines.csv :: UX 规则：AI Interaction/Feedback Loop（All）

### AI Interaction/Feedback Loop：把 UX 规则当作生成刹车——用 Severity 驱动的约束提示词
...
[质变临界]：当你追求一致性时可以牺牲一些个性，但别牺牲反馈与可读性
...
【思维模型】
【Constraint Macro（UX: AI Interaction/Feedback Loop）】
- 目标：AI needs user feedback to improve
- Do：Thumps up/down or 'Regenerate'
- Don’t：Static output only
- 严重度：Low（High=硬闸门，Medium=默认遵守，Low=可选）
...
Tag: UI/UX, 前端, UX规则, 反模式, 可用性, 提示词工程, ux:AI Interaction, issue:Feedback Loop, platform:All, severity:Low, 邻域:style, 邻域:color, 邻域:typography, 邻域:landing, 炫技vs可用性, 一致性vs灵活, keep:可访问性闸门, keep:交互反馈, adapt:平台规范, drop:无意义动效
