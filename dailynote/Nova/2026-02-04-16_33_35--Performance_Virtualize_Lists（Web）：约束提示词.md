[2026-02-04] - Nova
### Performance/Virtualize Lists（Web）：约束提示词

Repo: ui-ux-pro-max-skill
Origin: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill.git

Sources:
- src/ui-ux-pro-max/data/web-interface.csv :: Web 规则：Performance/Virtualize Lists

### Performance/Virtualize Lists：Web 接口规则=体验底盘——把语义与可访问性编译成约束提示词
...
【思维模型】
【Constraint Macro（Web: Performance/Virtualize Lists）】
- 目标：Virtualize lists exceeding 50 items
...
Tag: UI/UX, 前端, Web接口, 可访问性, 提示词工程, web:Performance, issue:Virtualize Lists, severity:High, 邻域:ux, 邻域:style, 邻域:color, 邻域:typography, 语义vs装饰, 一致性vs灵活, keep:语义HTML, keep:焦点可见, adapt:组件库, drop:无语义div
