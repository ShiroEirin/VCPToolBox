[2026-02-04] - Nova
### Podcast Platform（Color）：可控配色提示词

Repo: ui-ux-pro-max-skill
Origin: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill.git

Sources:
- src/ui-ux-pro-max/data/colors.csv :: 配色方案：Podcast Platform

### Podcast Platform：把配色当“语义系统”——从氛围到 token 的可控生成法
...
【思维模型】
【Prompt Macro（Color: Podcast Platform）】
- 氛围词：Dark audio + warm accent
- 语义契约：Primary=#1E1B4B；Secondary=#312E81；CTA=#F97316；BG=#0F0F23；Text=#F8FAFC
...
**证据来源**：src/ui-ux-pro-max/data/colors.csv :: Podcast Platform 行给出 Primary/Secondary/CTA/BG/Text 的角色化色值与备注，可直接落为主题 token
Tag: UI/UX, 前端, 配色, 色彩系统, 设计系统, 提示词工程, palette:Podcast Platform, 邻域:style, 邻域:typography, 邻域:landing, 邻域:chart, 语义色, 状态色, 氛围vs可读性, 品牌一致性vs灵活, keep:语义角色, keep:对比闸门, adapt:品牌色, drop:随机渐变
